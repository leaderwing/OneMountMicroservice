package com.quynx.microservice.logsModule.configuration;
...
@EnableJpaRepositories(basePackages = "com.quynx.microservice.logsModule.rest.logs.repositories")
public class HibernateConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.quynx.microservice.logsModule.rest.logs.entities");
